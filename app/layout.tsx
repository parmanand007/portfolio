...
export default function RootLayout({
  ...
  return (
    <html lang="en" className='!scroll-smooth'>
      ...
      relative  pt-28 sm:pt-36 dark:bg-gray-900 dark:text-gray-50 dark:text-opactiy-900
      `}>
        <div className='bg-[#fbe2e3] absolute  top-[-6rem] right-[11rem]
         -z-10   w-[31.25rem] rounded-full blur-[10rem] sm:w-[68.75rem]
         h-[31.25rem]  dark:bg-[#946263]
        '></div>
