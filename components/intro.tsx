...
const Intro = () => {
  ...
  return (
    <section ref={ref} className='mb-28 max-w-[50rem text-center sm:mb-0 scroll-mt-[100rem]' id="home"  >
      <div className="flex items-center justify-center">
        <div className='relative'>
            ...
            className='text-4xl bottom-0 right-0  absolute'>👋</motion.span>
         </div>
      </div>
    <motion.h1 className='mb-10 mt-14 px-4 text-2xl font-medium !leading-[1.5]
    sm:text-4xl  
    '
    ...
    href='/parmanand_prajapati.pdf' download
